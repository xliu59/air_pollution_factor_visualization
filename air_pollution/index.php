...
<html lang="en-US">
    ...
    <body>
        <div class="container-fluid site-wrapper" style="position: relative; z-index: 1;"> <!-- this is the Sheet -->
            ...
            <div class="container-fluid content-wrapper" id="content" style="position: relative; z-index: 0"> <!-- this is the Content Wrapper -->
                <div class="container">
                                    ...
                                    <div class="section article">
                                        <div class="content">
                                            <div class="img-simple span12 ">
                                                <div class="image">
                                                    <a rel="nofollow"  data-ss="imagemodal" data-href=""><img src="http://cdn.simplesite.com/i/2b/3d/283726781034872107/i283726791556726766._szw1280h1280_.jpg"></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div id="right" class="span3">
                            <div class="sidebar">
                                <div class="wrapper viral-box">
                                    ...
                                    <div class="content">
                                        <p>City dropdown list here</p>
                                        <div class="bottom">
                                            <a rel="nofollow"  href="" class="btn btn-block">Select</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="wrapper viral-box">
                                ...
                                <div class="wrapper viral-box">
                                    <div class="heading wordwrapfix">
                                        <h4>Select pollution level</h4>
                                    </div>
                                    <div class="content">
                                        <p>Select Buttons here</p>
                                        <div class="bottom">
                                            <a rel="nofollow"  href="" class="btn btn-block">Select</a>
                                        </div>
                                    </div>
                ...
                <div class="container">
                    <div class="footer-info" style="margin-bottom: 25px">
                        <div class="footer-info-text">
                            Database 415 Final Project </br>
                            By Xiaoxiao Liu & Da Chen
                        </div>
                    </div>
                </div>
            </div>
